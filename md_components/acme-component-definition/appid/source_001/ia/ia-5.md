...
x-trestle-comp-def-rules:
  appid:
    ...
    - name: appid_email_verification_for_cloud_directory_users_enabled
      description: Ensure App ID email verification is enabled for Cloud Directory
        users
    - name: appid_password_strength_regex_configured
      description: Ensure App ID password strength regex is configured
    - name: appid_advanced_password_policies_enabled
      description: Ensure App ID advanced password policies are enabled
    - name: app_id_cloud_directory_prevent_username_in_password_policy_is_enabled
      description: Ensure App ID Cloud Directory prevent username in password policy
        is enabled
    - name: 
...
### Rules:
  ...
  - appid_email_verification_for_cloud_directory_users_enabled
...
### Rules:
  ...
  - appid_advanced_password_policies_enabled
  - app_id_cloud_directory_prevent_username_in_password_policy_is_enabled
