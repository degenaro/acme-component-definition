...
x-trestle-comp-def-rules:
  appid:
    - name: appid_multifactor_authentication_mfa_enabled_for_cloud_directory_users
      description: Ensure App ID multifactor authentication (MFA) is enabled for Cloud
        Directory users
x-trestle-global:
  profile:
...
### Rules:
  ...
  - appid_multifactor_authentication_mfa_enabled_for_cloud_directory_users
